...
export function createCrawlerHandlers({
  ...
  function handleAnime() { return hubPageResponse('anime', '/anime'); }
  function handleShouldIWatchIndex() { return hubPageResponse('should-i-watch', '/should-i-watch'); }
