...
export const HUB_PAGES = {
  ...
  director: {
    title: 'Directors — Filmographies Ranked',
    description:
  ...
  newsletter: {
    ...
    description:
      'A weekly email of the most worth-watching movies and TV shows — climbing scores, new arrivals on every major streaming service, a curated mood pick, and one hidden gem.',
  },
  anime: {
  ...
  'how-we-rank': {
    title: 'How We Rank — The Bynge Score Methodology',
    description:
      'The Bynge Score blends TMDB, IMDb, Rotten Tomatoes, Metacritic, audience volume and freshness into a single 0–10 number. Here\'s exactly how it works.',
  },
  'coming-soon': {
    title: 'Coming Soon — Movies & TV Premiering Next',
    description:
      'Every movie and TV show premiering soon. Set reminders, build your watchlist, never miss a release.',
  },
  'coming-soon-movies': {
    title: 'Coming Soon — Movies Premiering Next',
    description:
      'Every upcoming movie release with a confirmed date, sorted by what drops first.',
  },
  'coming-soon-tv': {
    title: 'Coming Soon — TV Shows Premiering Next',
    description:
      'Every TV series premiere in the next two weeks — set your watchlist before they air.',
  },
  terms: {
  ...
  privacy: {
    ...
    description:
      'What Bynge collects, why, and what stays on your device. Google Analytics is opt-in via consent banner. We do not sell data, do not show ads, do not share emails. Plain-English privacy policy.',
  },
  dmca: {
    title: 'DMCA Notice — Bynge',
    description:
      'DMCA takedown process and rights-holder contact. Bynge does not host video files; we link to and embed from third-party providers. Submit notices through the channel below.',
  },
  home: {
    title: 'Bynge — Discover, Track and Binge Movies & TV Shows',
    description:
      'Bynge is a free movie and TV discovery site. Compare titles side by side, get a "Should I watch?" verdict, find hidden gems, browse every major streaming hub, and track your library — no signup required.',
  },
  movies: {
    title: 'Movies — Every Title, Filtered Your Way',
    description:
      'The full Bynge movie catalog. Filter by genre, sort by Bynge Score, and dive into editorial Best Of lists — from new releases to underrated classics.',
  },
  browse: {
    title: 'Shows — Browse the TV Catalog',
    description:
      'Every TV series Bynge tracks, filterable by genre, rating, and status. Browse running, ended, and upcoming shows ranked by Bynge Score.',
  },
  people: {
    title: 'People — Trending Actors, Directors & Creators',
    description:
      'Who is trending in film and TV right now. Browse trending actors, directors, and writers — and explore the projects they are best known for.',
  },
  genres: {
    title: 'Genres — Browse by Genre',
    description:
      'Action, drama, comedy, thriller, sci-fi, horror, romance, and more. Browse the full Bynge catalog by genre — TV and movies, side by side.',
  },
  country: {
    title: 'By Country — Movies from Around the World',
    description:
      'Movies sorted by country of origin. From Korean thrillers to French comedies to Iranian arthouse — Bynge surfaces the best of each region.',
  },
  calendar: {
    title: 'Airing Calendar — What Premieres When',
    description:
      'A daily and monthly TV airing calendar. See which episodes premiere each day and plan your viewing on Bynge.',
  },
  schedule: {
    title: 'TV Schedule — Today\'s Airings',
    description:
      'Today\'s full TV schedule across networks and streaming. See what\'s airing now and what\'s on later on Bynge.',
  },
};
